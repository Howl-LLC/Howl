...
// Type mirror for electron/streamdeck/schemas.js.
// __tests__/streamdeck/types-parity.test.ts asserts the runtime shape
// matches these TS types; drift fails CI.
