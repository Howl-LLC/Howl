...
export const APP_ICON_MAP: Record<string, React.FC<{ size?: number; className?: string }>> = {
  spotify: SpotifyIcon,
  twitch: TwitchIcon,
  youtube: YouTubeIcon,
  github: GitHubIcon,
